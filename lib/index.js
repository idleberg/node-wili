...
var realFetch__default = /*#__PURE__*/_interopDefaultLegacy(realFetch);
...
module.exports = function(url, options) {
	...
	return realFetch__default['default'].call(this, url, options);
};

if (!commonjsGlobal.fetch) {
	commonjsGlobal.fetch = module.exports;
	commonjsGlobal.Response = realFetch__default['default'].Response;
	commonjsGlobal.Headers = realFetch__default['default'].Headers;
	commonjsGlobal.Request = realFetch__default['default'].Request;
}
});

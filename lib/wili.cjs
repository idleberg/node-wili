...
var iconvLite__default = /*#__PURE__*/_interopDefaultLegacy(iconvLite);
...
function convertIconvLite(str, to, from) {
    if (to === 'UTF-8') {
        return iconvLite__default['default'].decode(str, from);
    } else if (from === 'UTF-8') {
        return iconvLite__default['default'].encode(str, to);
    } else {
        return iconvLite__default['default'].encode(iconvLite__default['default'].decode(str, from), to);
    }
}
